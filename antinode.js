...
server.on("listening", function () { return console.log("[+] AntiNode"); });
server.on("listening", function () { return console.log("[+] Status : Protected."); });